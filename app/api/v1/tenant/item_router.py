...
def list_items(
    ...
    return service.list_items(db, auth, search=search, offset=offset, limit=limit)
...
def get_item(
    ...
    return service.get_item(db, auth, part_number)
...
def get_item_bom_tree(
    ...
    return service.get_item_bom_tree(db, auth, part_number)
