...
public class MappingV2LlmGenerationSupport {

    private static final String SYSTEM_PROMPT_TEMPLATE = "classpath:prompts/mapping/v2/system.st";
    private static final String USER_PROMPT_TEMPLATE = "classpath:prompts/mapping/v2/user.st";
    ...
    private GenerationOutput generateByLlm(List<String> headers, List<Map<String, Object>> sampleRows)
        ...
        log.info(
                "event=mapping_v2_preview_llm_completed model={} elapsed={} input_tokens={} output_tokens={}",
                model,
                elapsedSeconds,
                inputTokens,
                outputTokens
        ...
        return new GenerationOutput(
                mappingV2NormalizationSupport.normalize(objectMapper.treeToValue(generatedJson, MappingV2ResultDto.class)),
                model,
                inputTokens,
                outputTokens
        );
