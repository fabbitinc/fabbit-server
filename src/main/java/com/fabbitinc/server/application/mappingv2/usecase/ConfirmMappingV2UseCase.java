...
@Transactional
public class ConfirmMappingV2UseCase {
    ...
    public SavedMappingV2Result execute(ConfirmMappingV2Command command) {
        ...
        SavedMappingV2Output output = mappingV2Service.createMapping(new CreateMappingV2Input(
                command.name(),
                command.fileId(),
                command.sheetName(),
                parsed.headers(),
