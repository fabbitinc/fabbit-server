...
public class ProjectController {
    ...
    public ProjectDetailResponse createProject(
        ...
        UUID projectId = createProjectUseCase.execute(request.name(), request.description());
        return projectQuery.getProjectDetail(projectId);
    }
    ...
    public ProjectListResponse listProjects(
        ...
        return projectQuery.listProjects(search, offset, limit);
    }
    ...
    public ProjectDetailResponse updateProject(
        ...
        UUID updatedProjectId = updateProjectUseCase.execute(projectId,
                request.name(),
                request.description()
        );
        return projectQuery.getProjectDetail(updatedProjectId);
    }
    ...
    public ResponseEntity<Void> archiveProject(
        ...
        archiveProjectUseCase.execute(projectId);
    ...
    public ResponseEntity<Void> unarchiveProject(
        ...
        unarchiveProjectUseCase.execute(projectId);
        return ResponseEntity.noContent().build();
    }
    ...
    public ActivityListResponse getProjectActivities(
        ...
        return projectQuery.getActivities(projectId, cursor, limit, scope, userId);
    }
}
