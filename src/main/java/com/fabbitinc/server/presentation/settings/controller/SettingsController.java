...
public class SettingsController {
    ...
    @Operation(summary = "GET /api/v1/settings", description = "초기 렌더에 필요한 설정 값을 조회합니다")
    @GetMapping
    ...
    @Operation(summary = "PUT /api/v1/settings/parts/workflow-policy", description = "부품 워크플로 정책을 변경합니다")
