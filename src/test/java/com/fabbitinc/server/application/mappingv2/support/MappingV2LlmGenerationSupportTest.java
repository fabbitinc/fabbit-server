...
class MappingV2LlmGenerationSupportTest {
    ...
    void generate_llm키가없으면_즉시_예외를_던진다() {
        MappingV2LlmGenerationSupport support = new MappingV2LlmGenerationSupport(
                appProperties(""),
                new ObjectMapper(),
                mock(MappingV2NormalizationSupport.class),
    ...
    void buildUserPrompt_원본과같은_json포맷을_사용한다() throws Exception {
        ...
        when(resourceLoader.getResource("classpath:prompts/mapping/v2/user.st")).thenReturn(userResource);
